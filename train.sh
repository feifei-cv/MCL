...
python train.py --name stage1_G2CI_19 --n_class 19 --img_size "1024,512" --resize 1024 --rcrop "512,256" --src_dataset gta5 --src_rootpath Dataset/GTA5 --tgt_dataset cityscapes idd --tgt_rootpath Dataset/Cityscapes Dataset/IDD_Segmentation --used_save_pseudo --rectify --resume_path ./logs/warmup_G2CI_19/from_gta5_to_2_on_deeplabv2_best_model.pkl
