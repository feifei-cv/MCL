...
#             self.load_state_dict(torch.load("pre/mit_b0.pth"), strict=False)
#
#
...
#         if pretrained:
#             print("Load backbone weights")
#             self.load_state_dict(torch.load("pre/mit_b1.pth"), strict=False)
#
#
...
#         if pretrained:
#             print("Load backbone weights")
#             self.load_state_dict(torch.load("pre/mit_b2.pth"), strict=False)
#
#
...
#         if pretrained:
#             print("Load backbone weights")
#             self.load_state_dict(torch.load("pre/mit_b3.pth"), strict=False)
#
#
...
#         if pretrained:
#             print("Load backbone weights")
#             self.load_state_dict(torch.load("pre/mit_b4.pth"), strict=False)
#
#
...
#         if pretrained:
#             print("Load backbone weights")
#             self.load_state_dict(torch.load("pre/mit_b5.pth"), strict=False)
#
...
def get_mit_backbone(model_name, pretrained=True):
    ...
    if pretrained:
        ...
        chkpt_state_dict = torch.load("pre/mit_{}.pth".format(model_name)) ##
        # remove head
